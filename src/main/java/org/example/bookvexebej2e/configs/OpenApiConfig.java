...
@Configuration
@OpenAPIDefinition(info = @Info(title = "Your Project API", version = "v1", description = "Documentation for the " +
    "main" + " REST API endpoints."), security = @SecurityRequirement(name = "bearerAuth"))
