...
import org.example.bookvexebej2e.service.NotificationService;
...
public class NotificationController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<NotificationResponse> update(@PathVariable UUID id, @RequestBody NotificationUpdate updateDto) {
