...
import org.example.bookvexebej2e.service.NotificationTypeService;
...
public class NotificationTypeController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<NotificationTypeResponse> update(@PathVariable UUID id, @RequestBody NotificationTypeUpdate updateDto) {
