...
/*!40000 ALTER TABLE `car_seats` DISABLE KEYS */;
/*!40000 ALTER TABLE `car_seats` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `flyway_schema_history` VALUES (1,'1','initial schema','SQL','V1__initial_schema.sql',-282290285,'root','2025-09-28 17:43:54',31924,1),(2,'2','users have many roles','SQL','V2__users_have_many_roles.sql',15629448,'root','2025-09-30 04:14:40',1638,1);
...
-- Dump completed on 2025-09-30 11:15:59
